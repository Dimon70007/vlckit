...
# COMMON_FF_CFG_FLAGS="$COMMON_FF_CFG_FLAGS --disable-static" # do not build static libraries [no]
# COMMON_FF_CFG_FLAGS="$COMMON_FF_CFG_FLAGS --enable-shared" # build shared libraries [no]
